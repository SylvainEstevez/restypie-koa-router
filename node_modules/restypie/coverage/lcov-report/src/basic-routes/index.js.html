...
<html lang="en">
<head>
    <title>Code coverage report for src/basic-routes/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/basic-routes/</a> index.js
    </h1>
    <div class='clearfix'>
...
module.exports = {
  ...
  get OptionsRoute<span class="fstat-no" title="function not covered" >() {</span> <span class="cstat-no" title="statement not covered" >return require('./lib/options'); </span>}
};</pre></td></tr>
</table></pre>
