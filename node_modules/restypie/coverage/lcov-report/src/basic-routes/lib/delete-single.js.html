...
<html lang="en">
<head>
    <title>Code coverage report for src/basic-routes/lib/delete-single.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">src/basic-routes/lib/</a> delete-single.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    return Promise.try(function () {
      ...
      .then(function (count) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!Restypie.Utils.isValidNumber(count)) {
<span class="cstat-no" title="statement not covered" >          return bundle.next(new Error('deleteObject should resolve with an integer'));</span>
        }
